...
function wpsc_admin_dynamic_js() { 
	...
	$unique_names1 = Array('billingfirstname', 'billinglastname', 'billingaddress','billingaddressnumber','billingaddresscomplemento','billingaddressbairro', 'billingcity',
	'billingcountry', 'billingemail', 'billingphone', 'billingpostcode','billingcpf','billingrg','billingnascimento','billingstate',
	'delivertoafriend', 'shippingfirstname', 'shippinglastname', 'shippingaddress','shippingaddressnumber','shippingaddresscomplemento','shippingaddressbairro',
	...
	$unique_names = "<option value='-1'>Selecione um nome único</option>";
