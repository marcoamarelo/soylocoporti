  ...
  <h2 class='wpsc_special'><?php echo __('Shipping Options', 'wpsc');?></h2>
		...
		wpsc_settings_page_update_notification(); ?>
			...
			<?php } ?>
				...
				<tr>
					<th scope="row">
						<?php echo __('National vendor', 'wpsc');?>:
					</th>
					<td>
					<?php
					$national_vendor = get_option('national_vendor');
					$national_vendor1 = "";
					$national_vendor2 = "";
					switch($national_vendor) {    
						case 1:
							$national_vendor1 = "checked ='checked'";
							break;
													
						case 0:
						default:
							$national_vendor2 = "checked ='checked'";
							break;
					}
							
					?>
							<input type='radio' value='1' name='wpsc_options[national_vendor]' id='national_vendor2' <?php echo $national_vendor1; ?> /> <label for='national_vendor1'><?php echo __('Yes', 'wpsc');?></label>&nbsp;
							<input type='radio' value='0' name='wpsc_options[national_vendor]' id='national_vendor1' <?php echo $national_vendor2; ?> /> <label for='national_vendor2'><?php echo __('No', 'wpsc');?></label><br />
							<?php echo __('If you are only selling to your base country, you should select yes.', 'wpsc');?>
					</td>
				</tr>
