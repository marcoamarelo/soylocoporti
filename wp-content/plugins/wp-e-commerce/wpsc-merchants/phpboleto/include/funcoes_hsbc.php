...
//Guarda inicial
$output .= "<img src='". $base_url ."/imagens/p.png' width=$fino height=$altura border=0><img 
...
$output .= "src='".$base_url."/imagens/p.png' width=$f1 height=$altura border=0><img "; 
...
$output .= "src='".$base_url."/imagens/b.png' width=$f2 height=$altura border=0><img "; 
  }
}
// Draw guarda final

$output .= "src='".$base_url."/imagens/p.png' width=$largo height=$altura border=0><img 
src='".$base_url."/imagens/b.png' width=$fino height=$altura border=0><img 
