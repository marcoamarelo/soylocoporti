	...
	<?php if(wpsc_display_products()): ?>
		<?php if(wpsc_is_in_category()) : ?>
			<div class='wpsc_category_details'>
				<div class="wpsc_category_text">
					<h3 class='wpsc_category_boundary'>
						<?php if( wpsc_category_group() == 4) echo 'Coleção '; ?><?php echo wpsc_current_category_name(); ?>
					</h3>
					<?php if(wpsc_category_description() && wpsc_category_group() == 4) : ?>
						<?php echo wpautop(wpsc_category_description()); ?>
					<?php endif; ?>
				</div>
				
				<?php if(wpsc_category_image()) : ?>
		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			...
			<?php 
				if ($produto_corrente == wpsc_the_product_id()) 
						continue;
					...
					<?php if(get_option('show_thumbnails')) :?>
						<div class="imagecol">
							<?php if(wpsc_the_product_thumbnail()) :?>
								<a rel="<?php echo str_replace(array(" ", '"',"'", '&quot;','&#039;'), array("_", "", "", "",''), wpsc_the_product_title()); ?>" class="preview_link" href="<?php echo wpsc_the_product_permalink(); ?>">
				...
				<div class="grid_9 omega">
					<div class="producttext">
						...
						*/ ?>
						...
						<a href="<?php echo wpsc_the_product_permalink(); ?>" title="Veja mais detalhes" class="detalhes">Detalhes</a>
		...
		<?php 
			$produto_corrente = wpsc_the_product_id();
