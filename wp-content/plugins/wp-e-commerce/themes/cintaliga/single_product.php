...
<div id='products_page_container' class="wrap wpsc_container">
	...
	<?php /** start the product loop here, this is single products view, so there should be only one */?>
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			<div class="produto single_product_display product_view_<?php echo wpsc_the_product_id(); ?>">
				<div>
					<?php if(get_option('show_thumbnails')) :?>
					<div class="grid_6 alpha">
						<div>
							<?php if(wpsc_the_product_thumbnail()) :?>
									<a rel="<?php echo str_replace(array(" ", '"',"'", '&quot;','&#039;'), array("_", "", "", "",''), wpsc_the_product_title()); ?>" class="jquery-zoom" href="<?php echo wpsc_the_product_image(); ?>">
										<img alt="Imagem do produto" class="product_image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_image( 305, 406 ); ?>" />
									</a>
									
									<div class="zoom-utility">
										<span class="jquery-zoom-info">Passe o mouse sobre a imagem para mais detalhes</span>
										<a rel="shadowbox" class="shadowbox-zoom" href="<?php echo wpsc_the_product_image(); ?>" title="<?php echo wpsc_the_product_title(); ?>">Ampliar imagem</a>
									</div>
							<?php else: ?> 
					...
					<div class="grid_6 omega">
						<div>
							...
							<?php echo wpsc_edit_the_product_link( 'Editar este produto' ); ?>
								<?php				
	            ...
	            ?>
						...
						<div class="ajuda-numeracao">Precisa de ajuda com a numeração? Veja a <a href="<?php echo get_page_link( get_page_by_title( 'Saiba seu tamanho' )->ID ); ?>" title="Saiba seu tamanho">tabela de tamanhos</a>.</div>						
						...
						<?php endif ;?>
							...
							<div class="wpsc_product_price">
								...
								<?php else : ?>
									<?php if(cinta_liga_product_on_special()) : ?>
										<span class='oldprice'><?php $oldprice = nzshpcrt_currency_display( $wpsc_query->product['price'], $wpsc_query->product['notax'], true ); echo $oldprice; //wpsc_product_normal_price(); ?></span><br />
									<?php endif; ?>
									<span id="product_price_<?php echo wpsc_the_product_id(); ?>" class="pricedisplay"><?php echo wpsc_the_product_price(); ?></span><br/>
						...
						?>
						<?php else : ?>
							<div class='soldout'><?php echo __('This product has sold out.', 'wpsc'); ?></div>
						<?php endif; //has_stock ?>
						</div>
					</div><!-- .grid -->
