						...
						<div>
							<?php if(wpsc_the_product_thumbnail()) :?>
									<a rel="<?php echo str_replace(array(" ", '"',"'", '&quot;','&#039;'), array("_", "", "", "",''), wpsc_the_product_title()); ?>" class="jquery-zoom" href="<?php echo wpsc_the_product_image(); ?>">
										<img alt="Imagem do produto" class="product_image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_image( 305, 457 ); ?>" />
									</a>
							...
							<div class="wpsc_product_price">
								...
								<?php else : ?>
									<?php if(wpsc_product_on_special()) : ?>
										<span class='oldprice'><?php echo wpsc_product_normal_price(); ?></span><br />
									<?php endif; ?>
