...
function wpsc_the_purch_item_date(){
	global $purchlogs;
	return date('d/m/Y',$purchlogs->purchitem->date);
}
...
function wpsc_purchaselog_details_date(){
	global $purchlogitem;
//	exit('<pre>'.print_r($purchlogitem->extrainfo, true).'</pre>');
	return date('d/m/Y',$purchlogitem->extrainfo->date);
...
function wpsc_getall_billinginfo() {
	global $purchlogitem;
	return $purchlogitem->userinfo;	
}

function wpsc_getall_shippinginfo() {
	global $purchlogitem;
	return $purchlogitem->shippinginfo;	
}
