...
<div class="menu">
	<ul class="clearfix">
		...
		<li class="menu-loja<?php if(is_page('pagina-de-produtos')) { echo ' current_page_item'; } ?>"><a href="<?php echo get_page_link_by_slug('pagina-de-produtos') ?>" title="Lojinha do Soylocoporti produtos próprios e de parceiros...">Loja</a></li>
